...
exports.RatingByMechanicRelations = exports.RatingByMechanic = void 0;
...
exports.RatingByMechanic = (0, pg_core_1.pgTable)("rating_by_mechanic", Object.assign({ id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(), rating: (0, pg_core_1.integer)("rating").notNull(), text: (0, pg_core_1.text)("text").notNull(), mechanic_id: (0, pg_core_1.uuid)("mechanic_id")
        .notNull()
...
exports.RatingByMechanicRelations = (0, drizzle_orm_1.relations)(exports.RatingByMechanic, ({ one }) => ({
    user: one(user_profiles_schema_1.UserProfiles, {
        fields: [exports.RatingByMechanic.user_id],
        references: [user_profiles_schema_1.UserProfiles.user_id],
    }),
    mechanic: one(user_profiles_schema_1.UserProfiles, {
        fields: [exports.RatingByMechanic.mechanic_id],
        references: [user_profiles_schema_1.UserProfiles.user_id],
    }),
    service: one(service_progress_schema_1.ServiceProgress, {
        fields: [exports.RatingByMechanic.service_progress_id],
