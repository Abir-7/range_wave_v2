...
const getChatList = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield chat_service_1.ChatService.getChatlist(req.user.user_id, req.user.user_role);
...
const getAllMessageOfChat = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield chat_service_1.ChatService.getAllMessage(req.params.chat_room_id);
    (0, sendResponse_1.default)(res, {
        success: true,
